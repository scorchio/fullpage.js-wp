...
function fullpage_enqueue_scripts() {
  ...
  wp_enqueue_script('fullpage-init', get_template_directory_uri() . '/js/fullPage-init.js');
  wp_enqueue_script('fullpage-css', get_template_directory_uri() . '/js/jquery.fullPage.css');
}
